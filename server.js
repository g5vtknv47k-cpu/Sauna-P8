...
// Render health check: always return a lightweight 200 response.
app.get("/health", (req, res) => res.status(200).json({ ok: true, service: "sauna-p8" }));
...
server.listen(PORT, "0.0.0.0", () => {
  console.log(`Sauna P8 running on ${PORT}`);
});
